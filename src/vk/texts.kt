...
const val questionIdWasNotRecognized =
...
- "/список" - выведу список вопросов с их id, чтобы можно было удалить вопрос по id
- "/удалить 42" - удалю вопрос с id 42. Только нельзя удалить вопрос, если на него уже есть ответы, имей в виду.
- "/добавить Главный вопрос жизни смерти и всего такого?%42%PROMOCD" - добавлю новый вопрос с текстом "Главный вопрос жизни смерти и всего такого?". Ответом "42" и промокодом "PROMOCD"
- "/правила" - покажу правила для игроков;
- "/бот" - пнуть меня, чтобы я показал список доступных команд;
- "/угадали" - выведу список пользователей, которые правильно ответили на вопрос за последнюю неделю;
